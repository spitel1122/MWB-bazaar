...
const SalesManKYCForm: React.FC<SalesManKYCFormType> = ({ data, id }) => {
  ...
  const SignupSchema = Yup.object().shape({
    ...
    agent_contact_person: Yup.string().required("Contact person is required"),
                  ...
                  <Grid item lg={3.25} md={5} sm={6} className="bazaarplan-div">
                    <div style={{ paddingTop: "30px", paddingRight: "15px" }}>
                      <FormControl variant="standard" style={{ width: "100%" }}>
                        <p className="formTitle">Agent Name</p>
                        <Input
                    ...
                    <div style={{ paddingTop: "30px", paddingRight: "15px" }}>
                      <FormControl variant="standard" style={{ width: "100%" }}>
                        ...
                        <Input
                          id="standard-adornment-amount"
                          type="text"
                          value={values.agent_contact_person}
                          onChange={handleChange}
                          name="agent_contact_person"
                          onBlur={handleBlur}
                          error={Boolean(
                            errors.agent_contact_person &&
                            touched.agent_contact_person
                          )}
                          disabled={id ? true : false}
                        />
                        <Box sx={{ color: "red" }}>
                          <ErrorMessage name="agent_contact_person" />
                        </Box>
                      </FormControl>
                    </div>
                  </Grid>
