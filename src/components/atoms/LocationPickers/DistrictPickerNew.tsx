         ...
         <div className={"border-b border-b-[1px solid #eeeeee] mb-[20px]"}>
           ...
           <div className={"flex flex-row gap-[40px]"}>
             <div className={"flex flex-col gap-[5px]"}>
               <div className={"font-bold mb-[5px] flex flex-row gap-[10px]"}>
                 <input type={"checkbox"} />
                 <span>Bandorban Dhanmondi</span>
               </div>
             ...
             <div className={"flex flex-col gap-[5px]"}>
               <div className={"font-bold mb-[5px] flex flex-row gap-[10px]"}>
                 <input type={"checkbox"} />
                 <span>Daudkandi Dhanmondi</span>
               </div>
               <div className={"px-[12px] flex flex-col gap-[5px]"}>
                 <div className={"flex items-center gap-[10px]"}>
                   <input type={"checkbox"} />
                   <span>Dhaka Long Name Long Name</span>
                 </div>
                 <div className={"flex items-center gap-[10px]"}>
                   <input type={"checkbox"} />
                   <span>Cumilla</span>
             ...
             <div className={"flex flex-col gap-[5px]"}>
               <div className={"font-bold mb-[5px] flex flex-row gap-[10px]"}>
                 <input type={"checkbox"} />
                 <span>Khagrachori Dhanmondi</span>
               </div>
               <div className={"px-[12px] flex flex-col gap-[5px]"}>
                 <div className={"flex items-center gap-[10px]"}>
                   <input type={"checkbox"} />
